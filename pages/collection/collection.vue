	...
	<view class="page">
		...
		<scroll-view scroll-x class="tab-scroll">
			<view class="tab-container">
				<view v-for="(item, index) in tabs" :key="index" class="tab" :class="{ active: activeIndex === index }" @click="changeTab(index)">
					{{ item }}
				</view>
			</view>
		</scroll-view>
		...
		<scroll-view scroll-y class="list">
			<CollectViewCell v-for="(item, index) in list" :key="index" :data="item" @click="handleClick(index)" />
		</scroll-view>
	</view>
</template>

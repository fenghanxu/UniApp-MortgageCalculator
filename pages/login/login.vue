	...
	<view class="page">
		...
		<view class="card">
			...
			<view class="input-box">
				...
				<input v-model="phone" type="number" placeholder="请输入手机号码" class="input" @input="onPhoneInput" />
			</view>
			...
			<view class="input-box">
				...
				<input v-model="password" password placeholder="请输入手机密码" class="input" @input="onPasswordInput" />
			</view>

	...
	<view class="page">
		...
		<view class="card">
			...
			<view class="input-box">
				...
				<input v-model="password" class="input" type="number" password maxlength="18" placeholder="请输入6-18位密码" @input="handleInput" />
			</view>
			...
			<view class="label-row confirm-top">
				...
				<view class="match-status">
					<image class="match-icon" :src="isMatch ? '/static/resetPassword_check.png' : '/static/resetPassword_uncheck.png'" mode="aspectFit" />
			...
			<view class="input-box">
				<image class="icon" src="/static/login_passworld.png" mode="aspectFit" />
				<input v-model="confirmPassword" class="input" type="number" password maxlength="18" placeholder="请再次输入6-18位密码" @input="handleInput" />
			</view>
		</view>
